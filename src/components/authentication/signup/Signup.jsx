    ...
    return (
        <div>
            <form >
                ...
                <input required type="text" onChange={(e)=>setusername(e.target.value)}  placeholder="username"/> <br /> <br />
                <input type="email" onChange={(e)=>setemail(e.target.value)}  placeholder="Email" /> <br /><br></br>
